...
Begin Milestone 5: Invoices and Documents Domain. First inspect the existing
customer, workflow, database, permission, and export patterns. Implement the
invoice model and decimal-safe line-item calculations before protected
document storage and workflow integration.
